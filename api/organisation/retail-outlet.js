var organisation_business_outlet = 'organisation/business/outlet';
...
QUnit.test("CRUD " + organisation_business, function (assert) {
    ...
    a.get(function (response) {
        ...
        post_data = {business: data_outlet};
        ...
        API.testCRUD(b, organisation_business_outlet, post_data, put_data, undefined, undefined, assert, done);
    });
})
;